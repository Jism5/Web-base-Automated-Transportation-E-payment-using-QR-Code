...
$sql = mysqli_query($conn,"SELECT * FROM load_history WHERE request_load_status = 'active'");
                                ...
                                <table id="datatablesSimple" class="">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $row['request_load_status']?></td>
                                            <td><?php echo $row['load_amount']?></td>
                                            <td><?php echo $row['reference']?></td>
                                           <?php echo "<td><a href=\"getload.php?id=".$row['reference']."\">Load</a>";?>
                                           <?php echo "<a href=\"delete_load.php?id=".$row['reference']."\">Decline</a></td>";?>
