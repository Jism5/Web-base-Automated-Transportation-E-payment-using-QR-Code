...
require_once "check.php";
    ...
    $sql11 = "SELECT * FROM userdata WHERE email = '$email' and role = 'user'";
    $sql = mysqli_query($conn, "SELECT * FROM passenger_info");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Commuters Table</h1>
