...
// $sql = mysqli_query($conn,"SELECT * FROM rider_info WHERE and status = 'verified'");
// $result = mysqli_fetch_assoc($sql);
// $id = $result['id'];

// $admin = mysqli_query($conn,"SELECT * FROM riders_log WHERE role = 'admin' and status = 'verified'");
                                ...
                                <table id="datatablesSimple" class="">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo $row['verify_status']?> <a href="Aviewlicense.php?id=<?php echo $row['riders_id']; ?>">view</a></td>
